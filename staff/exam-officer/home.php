            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="dashboard-card-wide dashboard-name">
                        ...
                        ?>
                        <p class="dashboard-main-text">Welcome back, <?php echo $fetchUser['staff_first_name'].' '.$fetchUser['staff_middle_name'].' '.$fetchUser['staff_last_name']?></p>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card dashboard-card">
                        <div class="header">
                            <p class="table-subheader" style="font-weight: 600;">Admission Officer Accounts</p>
                        </div>
